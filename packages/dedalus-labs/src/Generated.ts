...
export class LocalShellToolCallOutput extends S.Class<LocalShellToolCallOutput>(
     ...
     */
    output: S.String,
    status: S.optionalWith(LocalShellToolCallOutputStatusEnum, {
        nullable: true,
    }),
}) {}
...
export class CreateEvalCompletionsRunDataSource extends S.Class<CreateEvalCompletionsRunDataSource>(
    ...
    sampling_params: S.optionalWith(
        S.Struct({
             ...
             */
            tools: S.optionalWith(S.Array(ChatCompletionTool), {
                nullable: true,
            }),
        }),
        { nullable: true },
...
export class FineTuneMethod extends S.Class<FineTuneMethod>("FineTuneMethod")({
    ...
    reinforcement: S.optionalWith(FineTuneReinforcementMethod, {
        nullable: true,
    }),
}) {}
...
export class ImagesResponse extends S.Class<ImagesResponse>("ImagesResponse")({
     ...
     * The output format of the image generation. Either `png`, `webp`, or `jpeg`.
     */
    output_format: S.optionalWith(ImagesResponseOutputFormat, {
        nullable: true,
    }),
    /**
     * The size of the image generated. Either `1024x1024`, `1024x1536`, or `1536x1024`.
        ...
        S.Struct({
            ...
            changes_requested: S.optionalWith(
                S.Struct({
                     ...
                     */
                    api_call_logging: S.optionalWith(S.String, {
                        nullable: true,
                    }),
                    /**
...
export class ProjectCreateRequest extends S.Class<ProjectCreateRequest>(
     ...
     * Create the project with the specified data residency region. Your organization must have access to Data residency functionality in order to use. See [data residency controls](https://platform.openai.com/docs/guides/your-data#data-residency-controls) to review the functionality and limitations of setting this field.
     */
    geography: S.optionalWith(ProjectCreateRequestGeography, {
        nullable: true,
    }),
}) {}
...
export class ListUserRoleAssignmentsParams extends S.Struct({
    ...
    after: S.optionalWith(S.String, { nullable: true }),
    order: S.optionalWith(ListUserRoleAssignmentsParamsOrder, {
        nullable: true,
    }),
}) {}
            ...
            input: S.optionalWith(
                S.Struct({
                    ...
                    noise_reduction: S.optionalWith(
                        S.Struct({
                            type: S.optionalWith(NoiseReductionType, {
                                nullable: true,
                            }),
                        }),
                        { nullable: true },
...
export class CreateResponse extends S.Class<CreateResponse>("CreateResponse")({
    ...
    truncation: S.optionalWith(CreateResponseTruncationEnum, {
        nullable: true,
    }),
    top_logprobs: S.optionalWith(
        S.Int.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(20)),
    ...
    incomplete_details: S.NullOr(
        S.Struct({
            ...
            reason: S.optionalWith(
                S.Literal("max_output_tokens", "content_filter"),
                { nullable: true },
            ),
        }),
    ),
...
export const make = (
    ...
    return {
        ...
        pauseFineTuningJob: (fineTuningJobId) =>
            HttpClientRequest.post(
                `/fine_tuning/jobs/${fineTuningJobId}/pause`,
            ).pipe(
                withResponse(
                    HttpClientResponse.matchStatus({
                        "2xx": decodeSuccess(FineTuningJob),
        ...
        assignGroupRole: (groupId, options) =>
            HttpClientRequest.post(
                `/organization/groups/${groupId}/roles`,
            ).pipe(
                HttpClientRequest.bodyUnsafeJson(options),
                withResponse(
                    HttpClientResponse.matchStatus({
        ...
        addGroupUser: (groupId, options) =>
            HttpClientRequest.post(
                `/organization/groups/${groupId}/users`,
            ).pipe(
                HttpClientRequest.bodyUnsafeJson(options),
                withResponse(
                    HttpClientResponse.matchStatus({
        ...
        listProjectGroups: (projectId, options) =>
            HttpClientRequest.get(
                `/organization/projects/${projectId}/groups`,
            ).pipe(
                HttpClientRequest.setUrlParams({
                    limit: options?.["limit"] as any,
                    after: options?.["after"] as any,
        ...
        CancelChatSessionMethod: (sessionId) =>
            HttpClientRequest.post(
                `/chatkit/sessions/${sessionId}/cancel`,
            ).pipe(
                withResponse(
                    HttpClientResponse.matchStatus({
...
export interface Client {
    ...
    readonly createConversationItems: (
        ...
        options: {
            readonly params?:
                | typeof CreateConversationItemsParams.Encoded
                | undefined;
    ...
    readonly listProjectGroupRoleAssignments: (
        ...
        groupId: string,
        options?:
            | typeof ListProjectGroupRoleAssignmentsParams.Encoded
            | undefined,
    ) => Effect.Effect<
        typeof RoleListResource.Type,
        HttpClientError.HttpClientError | ParseError
    ...
    readonly listProjectUserRoleAssignments: (
        ...
        userId: string,
        options?:
            | typeof ListProjectUserRoleAssignmentsParams.Encoded
            | undefined,
    ) => Effect.Effect<
        typeof RoleListResource.Type,
        HttpClientError.HttpClientError | ParseError
