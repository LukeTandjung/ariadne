...
export interface GenerateTextOptions<Tools extends Record<string, Tool.Any>> {
    ...
    readonly toolChoice?:
        | ToolChoice<
              { [Name in keyof Tools]: Tools[Name]["name"] }[keyof Tools]
          >
        | undefined;
